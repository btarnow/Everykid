"""Temporary file for getting used to python3 unit testing. Most code is
 directly copied from book_info_from_API.py. This file will grow stale and 
 is expected to be deleted once more comfort with pytest and mocking is gained."""
